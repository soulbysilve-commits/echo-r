...
export const metadata: Metadata = {
  title: "ECHO-R Founder Edition | Veritas Forge",
  description: "継続するAI人格ECHO-RのFounder Edition、研究、アーキテクチャ、料金、よくある質問。",
  alternates: {
    canonical: "https://echo-r.veritasforge.net/ja/echo-r",
    languages: {
      en: "https://echo-r.veritasforge.net/echo-r",
      ja: "https://echo-r.veritasforge.net/ja/echo-r",
    },
  },
};
...
export default function Home() {
    return (
      ...
      <LanguageSwitch current="ja" enHref="/echo-r" jaHref="/ja/echo-r" />
