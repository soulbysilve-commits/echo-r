...
export const metadata: Metadata = {
  title: "ECHO Agent 使用許諾契約書（EULA） | Veritas Forge",
  alternates: {
    canonical: "https://echo-r.veritasforge.net/ja/eula",
    languages: {
      en: "https://echo-r.veritasforge.net/eula",
      ja: "https://echo-r.veritasforge.net/ja/eula",
    },
  },
};

export default function EchoAgentEulaJa() {
  return (
    <main className="min-h-screen bg-black text-gray-300 py-24 px-6 selection:bg-blue-500/30">
      <LanguageSwitch current="ja" enHref="/eula" jaHref="/ja/eula" />
      <div className="mx-auto max-w-3xl">
        <a href="/ja/echo-agent" className="mb-8 inline-block text-sm font-bold uppercase tracking-widest text-blue-400 hover:text-blue-300">
          ← ECHO Agentへ戻る
        </a>
