...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
      <LanguageSwitch current="en" enHref="/" jaHref="/ja" />
      ...
      <section id="founder" className="mx-auto max-w-7xl px-6 py-28">
        ...
        <div className="mt-6 rounded-2xl border border-blue-500/30 bg-blue-500/10 p-6">
          ...
          <p className="mt-4 text-gray-400">
            ECHO-R’s monthly protocol fee covers personality continuity, memory
            governance, protocol maintenance, and operational support.
          </p>

          <p className="mt-3 text-gray-400">
            External API usage fees are not included. The Owner is responsible for
            all API keys, usage limits, model charges, and third-party infrastructure
            costs.
          </p>
        </div>
      </section>
      ...
      <section id="faq" className="mx-auto max-w-7xl px-6 py-28">
        ...
        <div className="mt-12 grid gap-4">
          ...
          {[
            ...
            [
              "Are API usage fees included?",
              "No. API usage fees are not included in the monthly protocol fee. The Owner is responsible for API keys, usage limits, external model charges, and third-party infrastructure costs.",
            ],
          ].map(([q, a]) => (
            <details
              key={q}
